...
<body>
    <nav class="navbar">
        <div class="container">
            ...
            <div class="logo-wrapper">
                <img class=logo src="images/logo-black.png" alt="">
            </div>
            <div class="nav-links">
                <a href="">SIGN IN</a>
    ...
    <div class="section-2">
        ...
        <div class="slider-container">
            <div class="description">
                ...
                <h1>Hunger Games</h1>
                <h3>Ksh 1000</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod empor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip</p>
                <a href=""><button class="shadow-btn">SHOP NOW</button></a>
            </div>
            <div class="images">
    ...
    <div class="section-3">
        <div class="sec-3-wrapper">
            <div class="section-3-left">
                <h1>We beleive everyone should have<br>fashion. And the latest looks.</h1>
    ...
    <div class="footer">
        ...
        <div class="col col-3">
            <h1>Our Partners</h1>
            <a href="">Fashion Stars</a>
            <a href="">Printz Collections</a>
            <a href="">Alphago</a>
        </div>
        <div class="col col-4">
            <h1>More Links</h1>
            <a href="">Testimonies</a>
            <a href="">Fashion Gala 2022</a>
            <a href="">Jobs</a>

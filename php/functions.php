...
function editUser($connection, $first_name, $last_name, $username, $number, $email, $password, $sesh_id) {
    $sql = "UPDATE users SET first_name = '$first_name', last_name = '$last_name', username = '$username', phone_no = '$number', email = '$email', password = '$password' WHERE users.user_id = '$sesh_id'";
